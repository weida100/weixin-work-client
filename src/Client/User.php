...
class User extends Base
{
     ...
     * "union_id":"ozynqsp2G2Za0-HQHKFrsZaRc","user_id":"7882xxx4946238",
     * "source_info":{"add_source":4,"op_user_id":0,"source_room_id":1069605131122281}},"error":0,"type":12001}
     *
     ...
     * "corp_id":"1970325326788","corp_short_name":"微信","desc":"3wsjRs0","email":"","internation_code":"",
     * "job":"","label_list":null,"mobile":"","mobile_list":["000003980"],"name":"hl","real_name":"","remark":"",
     * "sex":1,"source_info":{"add_source":4,"op_user_id":0,"source_room_id":1078832972},"status":2057,
     ...
     * {"data":{"contact_list":[{"account":"yh","avatar":"http://wework.qpic.cn/bizmail/RYUT9ia06KVp63dFTsTr5IqrMxGuR8KuoWd9lFz9l1WYDiaKSE22j15Q/0",
     ...
     * @author Weida
     */
    public function getInternalContact():ResponseInterface{
        $params=[
            'type'=>2500
        ];
        return $this->httpClient->postJson('',$params);
     ...
     *
     * {"data":{"contact_list":[{"account":"","add_time":0,"avatar":"http://wx.qlogo.cn/mmhead/Q3auHgzwzMx0MADvZdoOzfZVNlFDqWEedm37ahQ/0",
     * "corp_id":"19703x788","corp_name":"微信联系人","corp_short_name":"微信","desc":"","email":"","job":"","mobile":"",
     ...
     * @author Weida
     */
    public function getExternalContact():ResponseInterface {
        $params=[
            'type'=>2501
        ];
        return $this->httpClient->postJson('',$params);
